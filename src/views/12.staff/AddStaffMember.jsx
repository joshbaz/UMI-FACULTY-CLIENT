...
const AddStaffMember = ({ onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    createStaffMemberMutation.mutate(submitData, {
      onSuccess: (data) => {
        console.log('Staff member creation response:', data);
        toast.success('Staff member created successfully');
        // Handle different possible response structures
        const staffMemberData = data?.staffMember || data?.data || data;
        if (staffMemberData && staffMemberData.id) {
          onSuccess(staffMemberData);
        } else {
          console.error('Unexpected response structure:', data);
          // Still call onSuccess with the data we have
          onSuccess(data);
        }
      },
      onError: (error) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {formData.isExternal ? (
              // External staff member fields
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="externalInstitution">Institution *</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="externalDepartment">Department</Label>
                    <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="externalLocation">Location</Label>
                  <Input
                    id="externalLocation"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., Lecturer, Senior Lecturer, Professor"
                  disabled={createStaffMemberMutation.isPending}
                />
              </div>
              <div className="space-y-2">
