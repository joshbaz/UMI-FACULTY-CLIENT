...
import {  useGetPanelists, useGetProposalDefenses } from "../../store/tanstackStore/services/queries"
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const GradeProposalDefenseTable = ({ 
  ...
  const { data: allPanelists, isLoading: isPanelistsLoading } = useGetPanelists();
